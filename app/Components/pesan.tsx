...
const Pesan: React.FC = () => {
  ...
  const handlePesanClick = async () => {
    ...
    const layananElement = document.getElementById(
      "layanan"
    ) as HTMLSelectElement | null;
    const durasiElement = document.querySelector(
      'input[name="durasi"]:checked'
    ) as HTMLInputElement | null;
    const tglElement = document.getElementById(
      "tgl"
    ) as HTMLInputElement | null;
    const jamElement = document.getElementById(
      "jam"
    ) as HTMLInputElement | null;
    const paymentElement = document.getElementById(
      "payment"
    ) as HTMLSelectElement | null;
    const alamatElement = document.getElementById(
      "alamat"
    ...
    if (
      ...
      const message = `
Halo Bapak Rizki, saya telah melakukan pemesanan Layanan dengan data sebagai berikut:
------------------------------------------------------------------
*Data Diri*
Nama Lengkap          : ${nama}
...
`;
  ...
  return (
    <form action="" method="post" className={styles.form}>
      ...
      <input type="text" name="no" id="no" placeholder="Masukkan nomor aktif" />
      <br />
      ...
      <div style={{ display: "flex", alignItems: "center" }}>
        <input
          ...
          name="durasi"
          value="60"
          onChange={() => handleDurasiChange("60")}
        />
        ...
        <input
          ...
          name="durasi"
          value="90"
          onChange={() => handleDurasiChange("90")}
        />
        ...
        <input
          ...
          name="durasi"
          value="120"
          onChange={() => handleDurasiChange("120")}
        />
      ...
      <input type="date" name="tgl" id="tgl" style={{ width: "98%" }} />
      <br />

      <label htmlFor="jam">Waktu Reservasi</label>
      <input type="time" name="jam" id="jam" style={{ width: "98%" }} />
      <br />
      ...
      <textarea
        ...
        style={{ resize: "none", height: "100px", overflow: "hidden" }}
      ></textarea>
      <br />
